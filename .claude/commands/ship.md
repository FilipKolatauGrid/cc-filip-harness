---
description: Ship — validate deploy, write post-deploy notes
phase: integration
reads:
  - "## Deploy Checklist"
writes:
  - "## Post-Deploy"
hard_blocks:
  - condition: "## Deploy Checklist is empty"
    message: "Run `deploy` first. Output required in ACTIVE_TASK.md → ## Deploy Checklist."
---
