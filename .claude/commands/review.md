---
description: Code review — review diff against task acceptance criteria
phase: review
reads:
  - "## Test Results"
  - "git diff"
writes:
  - "## Review Findings"
hard_blocks:
  - condition: "## Test Results is empty"
    message: "Run `tests` first. Output required in ACTIVE_TASK.md → ## Test Results."
  - condition: "verification verdict in ## Test Results is not PASS"
    message: "Verification must pass before code review. Fix blockers in ## Test Results first."
---
