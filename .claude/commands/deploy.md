---
description: Deploy checklist — pre-deploy gate from review findings
phase: integration
reads:
  - "## Review Findings"
writes:
...
hard_blocks:
  - condition: "## Review Findings is empty"
    message: "Run `review` first. Output required in ACTIVE_TASK.md → ## Review Findings."
  - condition: "## Review Findings does not contain a Security Audit section"
    message: "Run `audit` first. Security audit required in ACTIVE_TASK.md → ## Review Findings before deploying."
  - condition: "any CRITICAL finding in ## Review Findings is unresolved"
    message: "Resolve all CRITICAL findings in ## Review Findings before deploying."
---
...
> "Run `audit` first. Security audit required in ACTIVE_TASK.md → ## Review Findings before deploying."
