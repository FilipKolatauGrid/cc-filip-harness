...
|----------|---------|----------|
| Full SDLC | read `full-sdlc.md` | Complete lifecycle |
| Feature | read `feature-build.md` | New feature, lighter planning |
| Bug fix | read `bug-fix.md` | Fix a bug, TDD-first |
| Refactor | read `refactor.md` | Structural cleanup, coverage-first |
